              ...
              return (
                <article
                  ...
                  className={`relative w-full rounded border ${
                    isSelected
                      ? "border-[#c81a1f] border ring-1 ring-[#c81a1f]"
                      : "border-[#D3D1D1]"
                ...
                >
                  {/* Order Badge */}
                  {isSelected && (
                    <div className="absolute -top-4 right-2 bg-white border-2 border-[#c81a1f] text-black px-2 py-1 rounded-xl text-sm font-bold">
                      #{orderIndex}
                    </div>
                  )}
                  ...
                  <div className="mt-2 flex justify-between items-center">
                    ...
                    {isSelected && (
                      <div className="flex gap-2">
                       <button
  type="button"
  className="px-2 py-1 border bg-black text-white rounded text-xs"
  onClick={(e) => {
    e.stopPropagation();
    moveProductUp(p.id);
  }}
